...
cd fabric
git checkout cb1b71f95eb767dad6f785ac93f4b7c01b2d57aa
...
git fetch https://gerrit.hyperledger.org/r/fabric refs/changes/97/14897/9 && git cherry-pick FETCH_HEAD
