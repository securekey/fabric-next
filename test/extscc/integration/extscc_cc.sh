...
export CORE_CHAINCODE_ID_NAME=extscc:1.0.0-rc1
...
go run ../fixtures/src/github.com/extscc_cc/extscc_cc.go&
...
export CORE_PEER_TLS_ROOTCERT_FILE=$GOPATH/src/github.com/hyperledger/fabric-sdk-go/test/fixtures/channel/crypto-config/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/cacerts/org2.example.com-cert.pem
go run ../fixtures/src/github.com/extscc_cc/extscc_cc.go&
