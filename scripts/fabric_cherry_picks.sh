...
git checkout 91340fe0c68b0589627da6d17dcd6f1c86206230
...
#https://gerrit.hyperledger.org/r/c/16643/ - Open - [FAB-7641] Fix panic when iterating over private data
git fetch https://gerrit.hyperledger.org/r/fabric refs/changes/43/16643/1 && git cherry-pick FETCH_HEAD
...
#https://gerrit.hyperledger.org/r/c/16569/ - Open - [WIP] Generalize deliver API handler
git fetch https://gerrit.hyperledger.org/r/fabric refs/changes/69/16569/6 && git cherry-pick FETCH_HEAD
#https://gerrit.hyperledger.org/r/c/16645/ - Open - [FAB-7419] WIP (UT is missing)
git fetch https://gerrit.hyperledger.org/r/fabric refs/changes/45/16645/1 && git cherry-pick FETCH_HEAD
