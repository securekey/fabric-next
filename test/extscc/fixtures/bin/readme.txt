...
# IMPORTANT: This example has the version (-v option) set to 0. Make sure to increase the version if the CC is changed!!!
../../../../build/bin/peer chaincode package -S -n extscc3 -p github.com/hyperledger/fabric/test/extscc/fixtures/src/github.com/extscc_cc_binary -v 0 ../deploy/extscc3.golang -l binary
