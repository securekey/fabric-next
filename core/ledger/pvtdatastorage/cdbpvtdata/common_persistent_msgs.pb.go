...
package cdbpvtdata // import "github.com/hyperledger/fabric/core/ledger/pvtdatastorage/cdbpvtdata"
...
func init() {
	proto.RegisterType((*ExpiryData)(nil), "cdbpvtdata.ExpiryData")
	proto.RegisterMapType((map[string]*Collections)(nil), "cdbpvtdata.ExpiryData.MapEntry")
	proto.RegisterType((*Collections)(nil), "cdbpvtdata.Collections")
	proto.RegisterMapType((map[string]*TxNums)(nil), "cdbpvtdata.Collections.MapEntry")
	proto.RegisterMapType((map[string]bool)(nil), "cdbpvtdata.Collections.MissingDataMapEntry")
	proto.RegisterType((*TxNums)(nil), "cdbpvtdata.TxNums")
	proto.RegisterType((*CollElgInfo)(nil), "cdbpvtdata.CollElgInfo")
	proto.RegisterMapType((map[string]*CollNames)(nil), "cdbpvtdata.CollElgInfo.NsCollMapEntry")
	proto.RegisterType((*CollNames)(nil), "cdbpvtdata.CollNames")
}
