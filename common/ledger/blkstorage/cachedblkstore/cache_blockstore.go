...
func newCachedBlockStore(blockStore blkstorage.BlockStore, blockIndex blkstorage.BlockIndex, blockCache blkstorage.BlockCache) *cachedBlockStore {
	s := cachedBlockStore{
...
func (s *cachedBlockStore) RetrieveBlocks(startNum uint64) (ledger.ResultsIterator, error) {
	return s.blockStore.RetrieveBlocks(startNum)
}
