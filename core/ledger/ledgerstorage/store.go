...
func (s *Store) CommitWithPvtData(blockAndPvtdata *ledger.BlockAndPvtData) error {
	stopWatch := metrics.StopWatch("ledgerstorage_CommitWithPvtData_time")
	defer stopWatch()
...
func (s *Store) GetPvtDataAndBlockByNum(blockNum uint64, filter ledger.PvtNsCollFilter) (*ledger.BlockAndPvtData, error) {
	stopWatch := metrics.StopWatch("ledgerstorage_GetPvtDataAndBlockByNum_time")
	defer stopWatch()
...
func (s *Store) GetPvtDataByNum(blockNum uint64, filter ledger.PvtNsCollFilter) ([]*ledger.TxPvtData, error) {
	stopWatch := metrics.StopWatch("ledgerstorage_GetPvtDataByNum_time")
	defer stopWatch()
