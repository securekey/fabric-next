...
func TestLookupTxLoc(t *testing.T) {
	...
	b0 := mocks.CreateMockBlock(0, mocks.NewSimpleTransaction(txnID0, "some-key", peer.TxValidationCode_VALID))
	b1 := mocks.CreateMockBlock(1, mocks.NewSimpleTransaction(txnID1, "some-key", peer.TxValidationCode_VALID))
