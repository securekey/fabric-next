...
func TestRetrieveTxByBlockNumTranNum(t *testing.T) {
	...
	eb0 := mocks.CreateMockBlock(0, mocks.NewSimpleTransaction("a", "keya", peer.TxValidationCode_VALID))
	eb1 := mocks.CreateMockBlock(1, mocks.NewSimpleTransaction("b", "keyb", peer.TxValidationCode_VALID))
	eb2 := mocks.CreateMockBlock(2, mocks.NewSimpleTransaction("c", "keyc", peer.TxValidationCode_VALID))
	cbs.blockStore.(*mockBlockStoreWithCheckpoint).BlocksByNumber[0] = eb0
	cbs.blockStore.(*mockBlockStoreWithCheckpoint).BlocksByNumber[1] = eb1
...
func TestRetrieveTxValidationCodeByTxID(t *testing.T) {
	...
	eb0 := mocks.CreateMockBlock(0, mocks.NewSimpleTransaction("a", "keya", etx0))
	eb1 := mocks.CreateMockBlock(1, mocks.NewSimpleTransaction("b", "keyb", etx1))
	eb2 := mocks.CreateMockBlock(2, mocks.NewSimpleTransaction("c", "keyc", etx2))
	cbs.blockStore.(*mockBlockStoreWithCheckpoint).BlocksByNumber[0] = eb0
	cbs.blockStore.(*mockBlockStoreWithCheckpoint).BlocksByNumber[1] = eb1
