...
func NewProvider(storageProvider pvtdatastorage.Provider, cacheProvider pvtdatastorage.Provider, missingDataIndexProvider *leveldbhelper.Provider) *CachedPvtDataProvider {
	p := CachedPvtDataProvider{
		storageProvider:          storageProvider,
		cacheProvider:            cacheProvider,
		missingDataIndexProvider: missingDataIndexProvider,
	}
