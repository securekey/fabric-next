...
func (s *cdbBlockStore) AddBlock(block *common.Block) error {
	...
	stopWatch := metrics.StopWatch("blkstorage_couchdb_addBlock_time")
	defer stopWatch()
...
func (s *cdbBlockStore) CheckpointBlock(block *common.Block) error {
	...
	stopWatch := metrics.StopWatch("blkstorage_couchdb_checkpointBlock_time")
	defer stopWatch()
...
func (s *cdbBlockStore) GetBlockchainInfo() (*common.BlockchainInfo, error) {
	stopWatch := metrics.StopWatch("blkstorage_couchdb_getBlockchainInfo_time")
	defer stopWatch()
...
func (s *cdbBlockStore) RetrieveBlocks(startNum uint64) (ledger.ResultsIterator, error) {
	stopWatch := metrics.StopWatch("blkstorage_couchdb_retrieveBlocks_time")
	defer stopWatch()
...
func (s *cdbBlockStore) RetrieveBlockByHash(blockHash []byte) (*common.Block, error) {
	stopWatch := metrics.StopWatch("blkstorage_couchdb_retrieveBlockByHash_time")
	defer stopWatch()
...
func (s *cdbBlockStore) RetrieveBlockByNumber(blockNum uint64) (*common.Block, error) {
	stopWatch := metrics.StopWatch("blkstorage_couchdb_retrieveBlockByNumber_time")
	defer stopWatch()
...
func (s *cdbBlockStore) RetrieveTxByID(txID string, _ ...cledger.SearchHint) (*common.Envelope, error) {
	stopWatch := metrics.StopWatch("blkstorage_couchdb_retrieveTxByID_time")
	defer stopWatch()
...
func (s *cdbBlockStore) RetrieveTxByBlockNumTranNum(blockNum uint64, tranNum uint64) (*common.Envelope, error) {
	stopWatch := metrics.StopWatch("blkstorage_couchdb_retrieveTxByBlockNumTranNum_time")
	defer stopWatch()
...
func (s *cdbBlockStore) RetrieveBlockByTxID(txID string) (*common.Block, error) {
	stopWatch := metrics.StopWatch("blkstorage_couchdb_retrieveBlockByTxID_time")
	defer stopWatch()
	const queryFmt = `
	{
		"selector": {
...
func (s *cdbBlockStore) RetrieveTxValidationCodeByTxID(txID string) (peer.TxValidationCode, error) {
	stopWatch := metrics.StopWatch("blkstorage_couchdb_retrieveTxValidationCodeByTxID_time")
	defer stopWatch()
	block, err := s.RetrieveBlockByTxID(txID)
