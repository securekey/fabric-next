...
func (s *mockGossipService) InitializeChannel(chainID string, committer committer.Committer, store privdata2.TransientStore, endpoints []string) {
	panic("not implemented")
}
...
func (s *mockGossipService) DistributePrivateData(chainID string, txID string, privateData *rwset.TxPvtReadWriteSet, ps privdata.PolicyStore, pp privdata.PolicyParser) error {
	panic("not implemented")
}
...
func (s *mockGossip) SendByCriteria(signedGossipMessage *proto.SignedGossipMessage, sendCriteria gossip2.SendCriteria) error {
	panic("not implemented")
}
