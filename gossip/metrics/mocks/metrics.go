...
type TestMetricProvider struct {
	...
	FakeOnlineGauge  *metricsfakes.Gauge
	FakeOfflineGauge *metricsfakes.Gauge
...
func TestUtilConstructMetricProvider() *TestMetricProvider {
	...
	fakeOnlineGauge := testUtilConstructGauge()
	fakeOfflineGauge := testUtilConstructGauge()
	...
	fakeProvider.NewGaugeStub = func(opts metrics.GaugeOpts) metrics.Gauge {
		...
		case gmetrics.OnlineOpts.Name:
			return fakeOnlineGauge
		case gmetrics.OfflineOpts.Name:
			return fakeOfflineGauge
